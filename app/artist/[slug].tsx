...
import { ChevronLeft, ImageIcon, ShoppingBag, Calendar, MapPin, Star, MessageSquare } from 'lucide-react-native';
      ...
      <ScrollView className="flex-1" showsVerticalScrollIndicator={false}>
        ...
        <View className="pt-16 px-6 pb-6">
          ...
          <TouchableOpacity 
            ...
            className="mt-4 flex-row items-center justify-center gap-2 bg-accent py-4 rounded-2xl shadow-sm"
          >
            <MessageSquare size={16} color="white" />
            <Text className="text-white font-sans font-bold uppercase tracking-widest text-[10px]">Contacter l'artiste</Text>
          </TouchableOpacity>
